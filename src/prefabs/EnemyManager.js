...
class EnemyManager {
    ...
    setupWaveConfigurations() {
        this.waveConfigurations = [
            ...
            { 
                ...
                allowedEnemies: [
                    { type: 'enemy1', probability: 0.6 }, // 60% chance for 'enemy1'
                    { type: 'enemy2', probability: 0.4 }  // 40% chance for 'enemy2'
                ]
            },
            { 
                duration: 30, 
    ...
    spawnEnemyOfType(enemyInfo) {
        ...
        console.log("Enemy Spawned at (" + x + ","+  y +") , Hero Position At : (" + this.scene.hero.x + ","+  this.scene.hero.y +")");
